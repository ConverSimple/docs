--- 
title: "Booking Agent"
description: "A multi-step booking agent with complex state management."
---

This example demonstrates a booking agent with a multi-step workflow, context management, and transaction-like processes.
