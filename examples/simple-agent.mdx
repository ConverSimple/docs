...
description: "A basic agent that provides weather information."
---

This example demonstrates a simple agent with a single tool that provides weather information.
