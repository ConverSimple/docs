...
- Allocates resources for conversation
...
- Connects to AI services (STT/LLM/TTS or STS)
- Notifies your agent
...
**Duration:** 100-5000ms (depends on tool)
...
**Best practices:**
- Keep tool execution under 3 seconds
...
- Stops audio processing pipeline
