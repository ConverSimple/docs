...
**Latency:** 200-600ms total
- Single unified service handles everything
- ~50% faster than STT mode
...
- Latency is critical (aim for < 600ms response time)
